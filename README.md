...
[![Tests](https://img.shields.io/github/workflow/status/array-like/rotate/ci:cover?event=push&label=tests)](https://github.com/array-like/rotate/actions/workflows/ci:cover.yml?query=branch:main)
